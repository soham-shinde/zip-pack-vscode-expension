...
export function activate(context: vscode.ExtensionContext) {
    let disposable = vscode.commands.registerCommand('zip-pack.createZip', async () => {
        ...
        if (fs.existsSync(gitignorePath)) {
            ...
            ignoredPatterns = gitignoreContent.split(/\r?\n/).filter(line => line && !line.startsWith('#'));
        }
        ...
        vscode.window.showInformationMessage(`Zip created at .compressed/${zipFileName}`);
    });
